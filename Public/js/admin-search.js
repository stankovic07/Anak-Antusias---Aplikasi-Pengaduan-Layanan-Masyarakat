    ...
    <div class="flex items-center gap-2">
        <button onclick="viewFlags(${r.id})"
        class="text-sm ${r.flagged ? 'text-red-500' : 'text-gray-400'} hover:text-red-700"
        title="Lihat flag">
    ...
    activeReportId = null;
    document.getElementById('modalStatusSelect').classList.remove('hidden');
    document.getElementById('saveStatusBtn').classList.remove('hidden');
}
